        ...
        <>
            <section className={styles.container}> 
                ...
                <div className={styles.cards}>
                    ...
                    <CardSkill title={"SQL/NOSQL"} src={"https://img.icons8.com/?size=100&id=bkvySlFV9zbe&format=png&color=7950F2"} />
                </div>
            </section>
